...
$script_path = 'http://sophrologylondon.com/sl_includes_fr/dd-formmailer.php';
...
$path_contact_page = 'http://sophrologylondon.com/contactez.php';
...
$recipients = 'brigitte@sophrologylondon.com';
...
$form_struct = '
	type=text|class=fmtext|label=Nom|fieldname=fm_name|max=100|req=true
	type=text|class=fmtext|label=Email|fieldname=fm_email|max=100|req=true|ver=email
	type=text|class=fmtext|label=Sujet|fieldname=fm_subject|max=100|req=true
	type=verify|class=fmverify|label=Vérification
...
$email_subject = 'SOPHROLOGY-LONDON: fm_subject';
...
$sent_message = '<div id="thanks">
<p>Merci - votre message a été envoyé.</p>
<p>Je vous répondrai dès que possible, normalement dans les 48h.</p>
<p>Merci de cliquer sur <a href="http://www.sophrologylondon.com/contactez.php">Contact</a> si vous souhaitez envoyer un autre message.</p>
</div>';
...
$verify_text = '263D59';		// hex code for text color
