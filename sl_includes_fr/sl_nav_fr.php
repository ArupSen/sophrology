<div id="topnav">
		<ul>
			<li id="nav_home"><a href="/accueil.php" title="Accueil" onfocus="if(this.blur)this.blur()">Accueil</a></li>
			...
			<li id="nav_news"><a href="/actualites.php" title="quoi de neuf?" onfocus="if(this.blur)this.blur()">Actualites</a></li>
			<li id="nav_contact"><a href="/contactez.php" title="contactez moi" onfocus="if(this.blur)this.blur()">Contact</a></li>
		</ul>
</div>
	<div class="clear"></div>
